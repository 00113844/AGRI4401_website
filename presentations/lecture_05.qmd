---
title: "Soil and Water Spatial Variability"
...
- Understand the functionality and architecture of the Smart-Map QGIS plugin  
- Learn the principles of Ordinary Kriging (OK) and Support Vector Machines (SVM) for digital soil mapping  
- Explore the use of Moran’s I for spatial covariate selection  
- Review model evaluation metrics: R² and RMSE  
- Compare predictive performance of OK vs SVM in soil chemical attribute mapping  
- Identify data requirements, sampling density, and workflows for a 75 ha field study  

::: notes
Participants will first gain a deep understanding of Smart-Map’s integration with QGIS 3.10+ and its Python/PyQt5 architecture. We’ll then delve into the geostatistical foundations of OK and kernel-based SVM, highlighting interpolation and prediction of soil properties. Next, we examine Moran’s I as a spatial autocorrelation metric for covariate selection. R² and RMSE will be discussed with field trial examples. Finally, we compare OK vs SVM performance in soil chemical mapping and outline field-study workflows.
:::
...
```{mermaid}
flowchart LR
  A[Saturation (0 kPa)] --> B[Field Capacity (−33 kPa)]
  B --> C[Wilting Point (−1500 kPa)]
```
...
- Extend 7Rs to protect aquifers from N & P leaching  
...
- Adaptive governance under water scarcity & climate change  
...
::: {.column width="40%"}
::: figure
![Contour farming and terracing diagram](images/contour_terracing_diagram.png){width="100%"}
:::
:::
...
- Multispecies cover crops by soil type & climate  
- UAV & satellite imagery for vigor assessment  
- Improves structure, OM, moisture retention  
- N-fixation, P mobilization, reduced leaching  
- Weed suppression with spot spraying  
- Data-driven seeding rate & mix deployment  

::: notes
Cover crops enhance aggregate stability, infiltration, and nutrient cycling. Remote sensing (NDVI) informs in-season management, and VRA seeding optimizes canopy cover and ecosystem services.
:::
...
- Site-specific nutrient management cycles  
- 4R stewardship in sub-humid vs semi-arid systems  
- GIS integration & interpolation (IDW, kriging, cokriging)  
- GNSS-guided VRA strategies  
- Environmental impact metrics & mitigation  
- Emerging research: ML recommendations, UAV hyperspectral, automated tools  

::: notes
Open discussion on methodologies, frameworks, tools, and future directions in precision nutrient management and soil-water integration.
:::
...
- Recap: QGIS Desktop 3.22 GUI enhancements  
- Core functions: visualization, editing, analysis, web publishing  
- Extensibility: Python plugins & console  
- Installation: binaries, source, external media  
- Community: docs, tutorials, forums, plugin repo  
- Next: hands-on practice & contributions  

::: notes
We’ve explored QGIS 3.22’s core features and precision PA workflows. Engage with the community, apply these tools in real projects, and contribute to the open-source ecosystem. Thank you!
:::