...
subtitle: "AGRI4401 · Precision Agriculture · Lecture 01"
author:
...
format:
  revealjs:
    ...
    height: 720
    margin: 0.08
    footer: "UWA · School of Agriculture and Environment · AGRI4401"
    logo: "assets/uwa-logo-white.png"
...
![](assets/uwa-logo-white.png){width=160}

### Introduction to Precision Agriculture
#### AGRI4401 · Precision Agriculture · Lecture 01
:::
...
1. Define precision agriculture and understand its core principles of site-specific management
2. Identify key enabling technologies: GPS/GNSS, IoT sensors, remote sensing, and variable rate technology
3. Evaluate economic and environmental benefits of precision agriculture adoption
4. Apply the 4 Rs framework (Right Source, Rate, Time, Place) to precision nutrient management
5. Recognize implementation challenges and adoption drivers in precision agriculture systems
:::
...
## Introduction to Precision Agriculture {background-color="#002147"}
...
## Historical Perspective of Precision Agriculture {background-color="#002147"}
...
::: {.r-fit-text style="color:#FFD100; text-align:center;"}
Questions?
:::

::: {style="color:#b3c6d9; text-align:center; font-size:0.7em; margin-top:1em;"}
gustavo.alckmin@uwa.edu.au · School of Agriculture and Environment
:::
