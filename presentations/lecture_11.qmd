---
title: "L11- Telematics and Data Management"
...
flowchart LR;
  ...
  Irrigation[Irrigation Module] ---> Dashboard;
```
...
- Peer-to-peer communication: e.g. harvester <-> chaser bin.  
...
- Real-time telemetry over radio/cellular links: continuous tracking of vehicles, and machinery (location, orientation, operator metrics, equipment maintenace)  
- Fleet monitoring & analytics: dashboards visualize performance, and support proactive maintenance scheduling  
- ISOBUS CANBUS standard compliance: machine parameters exposed directly as bus messages, reducing integration effort and improving data visibility  
...
[Data Manager for IoT in Ag](https://azure.microsoft.com/en-us/products/data-manager-for-agriculture/){preview-link="true"}


[Farm Beats](https://www.microsoft.com/en-us/research/project/farmbeats-iot-agriculture/){preview-link="true"}
...
{{< video https://www.youtube.com/watch?v=3RxgTGLti8E width="85%" height="85%" >}}
...
- John Deere Operation Centre provide a secure 'farm data space' under farmer control  
